  ...
  fetchUpdateScore() {
    fetch(`http://localhost:4000/api/score`, {
      ...
      headers: {
        ...
        Authorization:
          'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJkYWRhbmcxMjNAZ21haWwuY29tIiwidXNlcm5hbWUiOiJkYWRhbmcxMjMiLCJpYXQiOjE2MzcxMjI4NDB9.2vk1a_kMlmuklPDigMDmMTlOqGpMDKuJoSuc-Y5hJCQ',
      },
      body: JSON.stringify({
        gameId: '1',
        score: '1',
      ...
      .then((response) => console.log('tes'), response.json())
      .then((data) => {
        console.log(data);
      })
      .catch((error) => {
